...
2. Select Version Control and Git (Version Controal -> Git).
    + If you recieve a message say "Git Not Found", then you need to install Git ([Install Git Here](https://git-scm.com/downloads)). Once Git is installed, try setting up the project again in RStudio.
...
3. Paste the phyto repository URL (https://github.com/zsmith27/phyto.git) into the "Repository URL" box.
...
2. Find and click the Knit button (it looks like a ball of yarn) in the toolbar above the editor window.
    + If a window appears saying "Install Requred Packages" for R Markdown, install the necessary packages for knitting the document.
3. Hopefully the document will compile correctly. If the document does not compile correctly, try to interpret and correct for the error message returned. If you cannot interprete the error message, please [open a new issue on the GitHub respository for this document](https://github.com/zsmith27/phyto/issues) and I will try to help you resolve the issue.

### Getting Started

Load the necessary packages into the environment [@dowle_data.table:_2017; @wickham_httr:_2017; @grolemund_dates_2011; @wickham_stringr:_2017; @wickham_readxl:_2017; @lang_rcurl:_2016; @wickham_dplyr:_2017; @wickham_tidyr:_2017; @henry_purrr:_2017; @ChengleafletCreateInteractive2017; @OomsjsonlitePackagePractical2014; @MullerrprojrootFindingFiles2017]. 
