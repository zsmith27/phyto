...
Some of the salinity zones (`salzone`) differ from the categories in [@lacouture_phytoplankton_2006]. Salinity zones are converted to one of four categories: "f" (freshwater), "m" (mesohaline), "o" (oligohaline), and "p" (polyhaline).
```{r}
events.df <- events.df %>% 
